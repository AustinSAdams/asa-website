      ...
      <div className="text-lg text-center mt-3">
        ...
        <Card className="m-4 justify-items-center w-fit">
          <CardHeader>
            ...
            <CardDescription>
              Hi, I'm Austin! I focus on cybersecurity, digital forensics, and
              web development. I'm currently pursuing a Bachelors of Science in
              Computer Science at Louisiana Tech University, where I'm building
          ...
          <CardContent className="flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 justify-items-center">
              <div className="flex flex-col items-center text-center">
                <p className="mb-1">
                  Here, you can view some details about projects I've worked on,
                  including their name, description, and code!
                </p>
              ...
              <div className="flex flex-col items-center text-center">
                <p className="mb-1">
                  Learn more about the companies I've worked with, what I did at
                  the company, and tools I used!
                </p>
                <Card className="flex flex-col w-64 mt-auto">
                  <CardHeader>
                    <CardTitle className="flex justify-center items-center gap-3">
