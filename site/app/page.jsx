  ...
  return (
    <div className="flex flex-col w-full">
      <div className="text-lg text-center mt-3">
        <p>
          Welcome to my portfolio website! From here, you can get to know me, my
          experience, my projects, view my resume, and get into contact with me!
        </p>
        <Card className="m-4 justify-items-center w-fit">
          <CardHeader>
            ...
            <CardDescription>
              <p>
                Hi, I am Austin! I focus on cybersecurity, digital forensics,
                and web development. Currently, I am pursuing a Bachelors of
                Science in Computer Science at Louisiana Tech University, where
                I am building my skills in these areas.
                <br /> I enjoy solving complex problems and working on cool
                projects. Outside of work, I dabble with new technologies, work
                on personal projects, and listen to the Cyberwire podcast!
              </p>
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  gap-2 justify-items-center">
              <div className="flex flex-col items-center text-center">
                <p className="mb-1">
                  Here, you can view some details about projects I have worked
                  on, including their name, description, and code!
                </p>
              ...
              <div className="flex flex-col items-center text-center">
                <p className="mb-1">
                  Learn more about the companies I have worked with, what I did
                  at the company, and tools I used!
                </p>
                <Card className="flex flex-col w-64 mt-auto">
                  <CardHeader>
                    <CardTitle className="flex justify-center items-center gap-3">
