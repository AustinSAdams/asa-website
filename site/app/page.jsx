      ...
      <div className="text-lg text-center mt-3">
        ...
        <Card className="m-4 justify-items-center w-fit">
          <CardHeader>
            ...
            <CardDescription>
              Hi, I am Austin! I focus on cybersecurity, digital forensics, and
              web development.Currently, I am pursuing a Bachelors of Science in
              Computer Science at Louisiana Tech University, where I am building
              my skills in these areas.
              <br /> I enjoy solving complex problems and working on cool
              projects. Outside of work, I dabble with new technologies, work on
              personal projects, and listen to the Cyberwire podcast!
            </CardDescription>
          </CardHeader>
