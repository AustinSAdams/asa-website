    ...
    return (
        <div className="flex flex-col w-full h-full items-center justify-center p-4">
            <p className="text-center text-xl mb-2">
                Welcome to the contact page! From here you can reach out to me
                with questions through my contact form!
                <br />
                <br />
            ...
            {isSent && (
                <div className="flex flex-row w-full h-full m-4 justify-center">
                    <Card>
                        <CardHeader>
                            <CardTitle>Thank you for reaching out!</CardTitle>
                        </CardHeader>
                        <CardContent>
                            Please wait 2-3 business days for a reply. If you do
                            not recieve a reply within that time frame, feel
                            free to follow up with another email, or message me
                            on my socials!
                            <br />
                            <br />
                            Thanks, <br />
