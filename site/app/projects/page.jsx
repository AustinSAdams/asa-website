...
export default function Projects() {
    ...
    const projects = [
        ...
        },
        {
            ...
            imageURL: "/images/projects-page/portfolioSite.jpg",
            wip: false,
            description:
                "Portfolio showcasing my projects in software engineering. Includes tools for web development, cybersecurity, and automation, utilizing technologies like Next.js, Firebase, Rust, and more.",
            tags: "Web Development, Cybersecurity",
            href: "https://github.com/AustinSAdams/asa-website",
        },
    ];
    return (
        <div className="flex flex-col items-center mt-1 w-full h-full">
            <p className="text-center text-xl mb-2">
                Welcome to the projects page! From here you can check out the
                stuff I have worked on and am currently working on!
            </p>
